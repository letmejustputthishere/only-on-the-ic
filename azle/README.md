...
curl http://2222s-4iaaa-aaaaf-ax2uq-cai.localhost:4943/db

curl -X POST -H "Content-Type: application/json" -d "{ \"hello\": \"world\" }" http://2222s-4iaaa-aaaaf-ax2uq-cai.localhost:4943/db/update

curl -X POST http://2222s-4iaaa-aaaaf-ax2uq-cai.localhost:4943/balance
...
View your frontend in a web browser at `http://[canisterId].localhost:4943`.
